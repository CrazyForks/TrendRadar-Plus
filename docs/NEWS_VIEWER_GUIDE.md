...
- 可以通过修改 `trendradar/web/news_viewer.py` 中的 `PLATFORM_CATEGORIES` 来自定义分类
- 页面样式在 `trendradar/web/templates/viewer.html` 中，可根据需要定制
- 服务器代码在 `trendradar/web/server.py`，支持扩展更多 API 接口
