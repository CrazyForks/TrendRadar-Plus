/**
 * TrendRadar Read State Module
 * 已读状态管理
 */
(function(global) {
    'use strict';

    const TR = global.TrendRadar = global.TrendRadar || {};
    const storage = TR.storage;

    // === 常量 ===
    const READ_STORAGE_KEY = 'trendradar_read_news_v2';
    const OLD_STORAGE_KEY = 'trendradar_read_news';
